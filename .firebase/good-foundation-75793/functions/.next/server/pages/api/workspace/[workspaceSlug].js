...
const handler = async (req, res)=>{
    ...
    if (method === "DELETE") {
        ...
        (0,_prisma_services_workspace__WEBPACK_IMPORTED_MODULE_1__/* .deleteWorkspace */ .zl)(session.user.userId, session.user.email, req.query.workspaceSlug).then((slug)=>res.status(200).json({
                data: {
                    slug
                }
...
var __webpack_exports__ = __webpack_require__.X(0, [3679,441,7244,7950], () => (__webpack_exec__(83)));
