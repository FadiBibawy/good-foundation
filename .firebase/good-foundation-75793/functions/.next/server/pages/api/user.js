...
const handler = async (req, res)=>{
    ...
    if (method === "DELETE") {
        ...
        if (ALLOW_DEACTIVATION) {
            await (0,_prisma_services_user__WEBPACK_IMPORTED_MODULE_1__/* .deactivate */ .jK)(session.user.userId);
        }
        res.status(200).json({
            data: {
...
var __webpack_exports__ = __webpack_require__.X(0, [3679,441,7244,7074], () => (__webpack_exec__(3859)));
